...
In @fig-ppcheckandposteriorvsprior we compare the posterior with the prior. This shows... 
...
analysis_data <- arrow::read_parquet(here::here("outputs/data/analysis_data.parquet"))
